...
try: 
    additional_role_id, cost_additional_role = Utils.get_cost_additional_role()
except Exception:
...
class Shop(commands.Cog):
    ...
    async def shop(self, ctx):
        ...
        if roles:
            ...
            await ctx.response.send_message(embed=embed, view=ShopView(ctx, page, roles, total_pages, additional_role_id, cost_additional_role))
        else: 
